...
svn_export "openwrt-25.12" "utils/cgroupfs-mount" "feeds/packages/utils/cgroupfs-mount" "https://github.com/immortalwrt/packages"
...
svn_export "master" "net/ddns-go/Makefile" "feeds/packages/net/ddns-go/Makefile" "https://github.com/coolsnowwolf/packages"
